  ...
  return (
    <div className="min-h-screen bg-[#F5F1E8] py-20">
      <Helmet>
        ...
        <link rel="canonical" href={`https://urologo.damianmontes.medico.ec/service/${service.id}`} />
      </Helmet>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <article className="bg-white rounded-2xl p-8 shadow-sm border border-[#E8DCC8]">
          ...
          <img src={service.img} alt={service.title} className="w-full h-64 md:h-96 object-cover rounded-xl mb-8" />
          <p className="text-lg text-[#6D4C41] mb-8">{service.longDesc}</p>
